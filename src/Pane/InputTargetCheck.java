 ...
 */
public class InputTargetCheck extends javax.swing.JFrame {

    /**
     * Creates new form InputTargetCheck
     */
    public InputTargetCheck() {
        initComponents();
...
//        logged.addTargetBoolean(nama, category, date);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InputTargetCheck.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new InputTargetCheck().setVisible(true);
